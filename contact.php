...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#00FF33">LEAVE A MESSAGE </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Albert Timileyin Oloruntola <br> Manchester, United Kingdom<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone</abbr>: 809093960004</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com">atoloruntola@uclan.ac.uk</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Hours</abbr>: Monday - Saturday: 9:00 AM to 5:00 PM</p>
